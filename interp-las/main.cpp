 ...
 * The basic algorithm is based on Ramon Arrowsmith(ramon.arrowsmith@asu.edu)'s note
 * This program takes a set of randomly distributed points as input
 * and generates gridded points (DEM)
 *
 * FileName: main.cpp
